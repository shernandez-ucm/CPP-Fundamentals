# CS1 Lab - Namespace and Unittest

Possible Points: 100

Write a C++ program to solve the Kattis problemid grafaholur: [https://open.kattis.com/problems/grafaholur](https://open.kattis.com/problems/grafaholur). Note that the last part of the URL, e.g. `grafaholur` is the problem id. Read the problem statement carefully to design a correct solution.
