# CS1 Lab - Pointers and Unittest

Possible Points: 100

Write a C++ program to solve the Kattis problemid timeloop: [https://open.kattis.com/problems/timeloop](https://open.kattis.com/problems/timeloop). Note that the last part of the URL, e.g. `timeloop` is the problem id. Read the problem statement carefully to design a correct solution.
